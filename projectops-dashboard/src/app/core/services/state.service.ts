...
export class StateService {
  private readonly initialState: AppState = {
    ...
    user: {
      id: '1',
      name: 'Raúl Molina',
      email: 'raul.molina@projectops.com',
      role: 'Administrador'
    },
    notifications: [
      { id: '1', message: 'Nuevo proyecto "E-Commerce App" creado', type: 'success', timestamp: new Date() },
      { id: '2', message: 'La tarea "Diseño UI" está vencida', type: 'warning', timestamp: new Date(Date.now() - 3600000) },
      { id: '3', message: '3 tareas completadas hoy', type: 'info', timestamp: new Date(Date.now() - 7200000) },
    ]
  };
